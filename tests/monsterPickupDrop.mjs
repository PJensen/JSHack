...
// Move monster onto gold tile
world.add(mid, MoveIntent, { dx: 1, dy: 0 });
world.tick(1);

// Monster should now be at (1,0) and have gold in inventory even with capacity 0
...
// Kill the monster and run cleanup
const mvit = world.get(mid, Vitality);
mvit.hp = 0;
world.tick(1);

// After cleanup, monster should be destroyed and gold should be on the ground at (1,0)
...
console.log('Monster pickup+drop test PASS');
