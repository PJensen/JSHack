...
export const MAX_LOAD_RATIO = 1.25;

/** Stamina regeneration retained at each encumbrance tier. */
export const HEAVY_STAMINA_REGEN_MULTIPLIER = 0.50;
export const OVERLOADED_STAMINA_REGEN_MULTIPLIER = 0;
