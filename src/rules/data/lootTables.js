...
export const LOOT_TABLES = {
  ...
  "sub:melee_weapons": {
    ...
    entries: [
      ...
      { type: "equip", weight: 22, pool: ["axe_heavy", "iron_mace"],                            affixChance: 0.25, affixCountMax: 1 },
      { type: "equip", weight: 16, pool: ["longsword"],                                          affixChance: 0.30, affixCountMax: 1 },
      { type: "equip", weight: 14, pool: ["warhammer", "venomfang_dagger"],                      affixChance: 0.25, affixCountMax: 1 },
  ...
  "drop:tier3": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 12, pool: ["axe_heavy", "chain_armor", "amulet_vigor", "belt_girded", "gauntlets_iron", "greaves_steel", "helm_steel", "shield_iron", "ring_health", "ring_precision", "ring_arcana", "ring_fire_resist", "ring_poison_resist", "shield_fireward", "warhammer", "venomfang_dagger", "leadweave_mantle", "ring_endurance", "shield_spiked_pavise"],
  ...
  "chest:basic": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 14, pool: ["leather_armor", "helm_iron", "amulet_guarded", "belt_leather", "gloves_leather", "leggings_leather", "shield_wood"], affixChance: 0 },
  ...
  "chest:epic": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 20, pool: ["helm_warhelm", "helm_visionary", "pendant_soulkeeper", "pendant_stormward", "belt_ironhide", "belt_vitality", "gauntlets_spiked", "gloves_arcane", "ring_of_fury", "serpent_ring", "wardkeeper_shield"], affixChance: 0.50, affixCountMax: 2 },
