...
export const LOOT_TABLES = {
  ...
  "sub:equip_magic": {
    ...
    entries: [
      ...
      { type: "equip", weight: 8,  pool: ["caustic_stiletto"], affixChance: 0.2, affixCountMax: 1 },
      { type: "equip", weight: 8,  pool: ["stormtouched_mace"], affixChance: 0.2, affixCountMax: 1 },
      { type: "equip", weight: 8,  pool: ["grounded_buckler"], affixChance: 0.2, affixCountMax: 1 },
    ],
  },
  ...
  "drop:tier3": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 8,  pool: ["caustic_stiletto", "stormtouched_mace", "grounded_buckler"],
        affixChance: 0.50, affixCountMax: 1 },
  ...
  "chest:magic": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 6,  pool: ["caustic_stiletto", "stormtouched_mace", "grounded_buckler"],
        affixChance: 0.40, affixCountMax: 1 },
      { type: "table",     weight: 10, tableId: "sub:wands" },
