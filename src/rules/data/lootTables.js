...
export const LOOT_TABLES = {
  ...
  "sub:equip_magic": {
    ...
    entries: [
      ...
      { type: "equip", weight: 16, pool: ["helm_iron"], affixChance: 0.3, affixCountMax: 1 },
  ...
  "chest:basic": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 12, pool: ["leather_armor", "helm_iron", "shield_wood"], affixChance: 0 },
  ...
  "chest:magic": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 15, pool: ["chain_armor", "helm_iron", "shield_iron", "shield_fireward", "ring_health", "ring_precision", "ring_fire_resist"], affixChance: 0.40, affixCountMax: 1 },
