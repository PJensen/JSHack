...
export const LOOT_TABLES = {
  ...
  "drop:tier1": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 10, pool: ["axe_heavy", "chain_armor", "ring_health", "ring_fire_resist", "ring_poison_resist"], affixChance: 0.20, affixCountMax: 1 },
  ...
  "drop:tier2": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 15, pool: ["ring_health", "ring_precision", "ring_arcana", "ring_fire_resist", "ring_poison_resist"], affixChance: 0.40, affixCountMax: 1 },
  ...
  "drop:tier3": {
    ...
    entries: [
      ...
      { type: "table",     weight: 15, tableId: "sub:scrolls" },
      { type: "equip",     weight: 15, pool: ["axe_heavy", "chain_armor", "shield_iron", "ring_health", "ring_precision", "ring_arcana", "ring_fire_resist", "ring_poison_resist", "shield_fireward"],
  ...
  "drop:dragon": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 25, pool: ["axe_heavy", "chain_armor", "shield_iron", "ring_health", "ring_precision", "ring_arcana", "ring_fire_resist", "ring_poison_resist", "shield_fireward"],
        affixChance: 0.80, affixCountMax: 2 },
      { type: "table",     weight: 20, tableId: "sub:spellbooks" },
      { type: "archetype", weight: 15, archetype: "HealthPotion" },
      { type: "table",     weight: 10, tableId: "sub:scrolls" },
  ...
  "drop:lich": {
    ...
    entries: [
      ...
      { type: "table",     weight: 15, tableId: "sub:scrolls" },
      { type: "equip",     weight: 15, pool: ["ring_health", "ring_precision", "ring_arcana", "ring_fire_resist", "ring_poison_resist"],
  ...
  "chest:magic": {
    ...
    entries: [
      ...
      { type: "table",     weight: 15, tableId: "sub:spellbooks" },
      { type: "table",     weight: 15, tableId: "sub:scrolls" },
      { type: "equip",     weight: 10, pool: ["axe_heavy", "chain_armor", "shield_iron", "shield_fireward"],
        affixChance: 0.50, affixCountMax: 2 },
      { type: "table",     weight: 10, tableId: "sub:wands" },
  ...
  "chest:legendary": {
    rolls: { min: 4, max: 6 },
    entries: [
      { type: "equip",     weight: 30, pool: ["axe_heavy", "chain_armor", "shield_iron", "ring_health", "ring_precision", "ring_arcana", "ring_fire_resist", "ring_poison_resist", "shield_fireward"],
