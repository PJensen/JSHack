...
export const LOOT_TABLES = {
  ...
  "drop:tier0": {
    ...
    entries: [
      ...
      { type: "table",     weight: 24, tableId: "sub:equip_common" },
      { type: "table",     weight: 18, tableId: "sub:equip_early_proc" },
  ...
  "drop:tier1": {
    ...
    entries: [
      ...
      { type: "gold",      weight: 40, count: { base: 14, perDepth: 5 } },
      { type: "table",     weight: 22, tableId: "sub:potions" },
      { type: "table",     weight: 16, tableId: "sub:equip_common" },
      { type: "table",     weight: 16, tableId: "sub:equip_early_proc" },
      { type: "table",     weight: 22, tableId: "sub:equip_magic" },
      { type: "table",     weight: 14, tableId: "sub:equip_rare" },
      { type: "table",     weight: 8,  tableId: "sub:equip_epic" },
      { type: "table",     weight: 2,  tableId: "sub:equip_legendary" },
      { type: "equip",     weight: 12, pool: ["axe_heavy", "chain_armor", "amulet_vigor", "belt_girded", "gauntlets_iron", "greaves_steel", "helm_steel", "ring_health", "ring_fire_resist", "ring_poison_resist", "warhammer", "venomfang_dagger", "ring_endurance"], affixChance: 0.45, affixCountMax: 1 },
