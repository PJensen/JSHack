...
export const LOOT_TABLES = {
  ...
  "sub:equip_magic": {
    ...
    entries: [
      ...
      { type: "equip", weight: 18, pool: ["bow_long"], affixChance: 0.3, affixCountMax: 1 },
  ...
  "chest:magic": {
    ...
    entries: [
      ...
      { type: "table",     weight: 22, tableId: "sub:potions" },
      { type: "equip",     weight: 15, pool: ["axe_heavy", "longsword", "warhammer", "venomfang_dagger", "bow_long"], affixChance: 0.40, affixCountMax: 1 },
  ...
  "chest:epic": {
    ...
    entries: [
      ...
      { type: "equip",     weight: 20, pool: ["nightfang_dagger", "pyreheart_mace", "glacial_edge", "witchfire_sword", "howling_maul", "ashen_reaver", "bow_composite"], affixChance: 0.50, affixCountMax: 2 },
