...
export const MATERIAL_REACTION_RULES = [
  ...
  },
  {
    ...
    eventKind: "water:dipped",
    reactions: [
      // Holy water two-step: cursed → uncursed first, then uncursed → blessed on second dip
      {
        id: "holy_water_uncurses_cursed_equipment",
        match: { itemTypes: ["equip"], beatitudes: ["cursed"] },
        waterTypes: ["holy"],
        outcome: "set_beatitude",
        state: "uncursed",
        result: "uncursed",
      ...
      {
        id: "holy_water_blesses_uncursed_equipment",
        match: { itemTypes: ["equip"], beatitudes: ["uncursed"] },
        waterTypes: ["holy"],
        outcome: "set_beatitude",
        state: "blessed",
        result: "blessed",
      ...
      {
        id: "plain_water_uncurses_equipment",
        match: { itemTypes: ["equip"] },
        waterTypes: ["plain"],
        outcome: "set_beatitude",
        state: "uncursed",
  ...
  {
    id: "water_dip_sets_ammo_beatitude",
    sourceEvents: ["water:dipped"],
    itemScopes: ["target"],
    eventKind: "water:dipped",
    reactions: [
      // Holy water two-step: cursed → uncursed, uncursed → blessed
      {
        id: "holy_water_uncurses_cursed_ammo",
        match: { itemTypes: ["ammo"], beatitudes: ["cursed"] },
        waterTypes: ["holy"],
        outcome: "set_beatitude",
        state: "uncursed",
        result: "uncursed",
      ...
      {
        id: "holy_water_blesses_uncursed_ammo",
        match: { itemTypes: ["ammo"], beatitudes: ["uncursed"] },
        waterTypes: ["holy"],
        outcome: "set_beatitude",
        state: "blessed",
        result: "blessed",
      ...
      {
        id: "unholy_water_curses_ammo",
        match: { itemTypes: ["ammo"] },
        waterTypes: ["unholy"],
        outcome: "set_beatitude",
        state: "cursed",
        result: "cursed",
