...
[
  ...
  ["fireWard1", { name: "Flame Ward", slots: ["armor", "offhand", "neck"], weight: 18, passiveRefs: [AFFIX_FIRE_WARD] }],
  ["poisonWard1", { name: "Venom Ward", slots: ["armor", "ring", "neck"], weight: 18, passiveRefs: [AFFIX_POISON_WARD] }],
  ["kineticWard1", { name: "Fortified", slots: ["armor", "offhand", "neck"], weight: 15, passiveRefs: [AFFIX_KINETIC_WARD] }],
