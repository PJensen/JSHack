...
/** @typedef {{ id:string, name:string, tags?:string[], tier:number, intelligence?:number, visionRange?:number, fovConeDegrees?:number, faction?:string, solid?:boolean, blocksSight?:boolean, baseHp:number, hpPerLevel:number, attack:number, defense:number, damageDice:string, sizeClass:string, massKg:number, resistances:Object, speed:number, hooks?:Record<string, Function[]>|null, specials?:string[], description:string, lootTable?:string, corpseDropChance?:number, sleep?:string|{pattern?:string,context?:string,chance?:number}, polymorphResistance?:number, polymorphStability?:string, equipment?:{ranged?:string, ammo?:string}|null, guardianRole?:{role?:string,radius?:number,peacefulUntilDisturbed?:boolean}|null, wielding?:Array<string|{itemId?:string,id?:string,affixes?:string[],count?:number,slot?:string}>, equipped?:Array<string|{itemId?:string,id?:string,affixes?:string[],count?:number,slot?:string}>, inventory?:Array<string|{itemId?:string,id?:string,affixes?:string[],count?:number,slot?:string}>, learnedSpellIds?:string[], maxMana?:number, manaRegen?:number }} MonsterDef */
