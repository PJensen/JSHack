...
export const GEM_DEFS = {
  ...
  gem_opal:        { id: 'gem_opal',        name: 'Opal',                appearance: 'White Gem',           value: 800,  weight: 1, hardness: 'soft', prob: 12,  material: 'gemstone', socketable: true, socketAffixId: 'gem_socket:opal' },
  ...
  gem_garnet:      { id: 'gem_garnet',      name: 'Garnet Stone',        appearance: 'Red Gem',             value: 700,  weight: 1, hardness: 'soft', prob: 12,  material: 'gemstone', socketable: true, socketAffixId: 'gem_socket:garnet' },
  gem_amethyst:    { id: 'gem_amethyst',    name: 'Amethyst Stone',      appearance: 'Violet Gem',          value: 600,  weight: 1, hardness: 'soft', prob: 14,  material: 'gemstone', socketable: true, socketAffixId: 'gem_socket:amethyst' },
