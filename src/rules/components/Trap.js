...
// Trap component: attaches to an entity at a location.
// Fields:
// - type: logical trap type (e.g., "spike")
// - revealed: whether the trap has been revealed (displayed)
// - armed: whether the trap can be triggered
// - damage: flat damage dealt on trigger (for simple traps)
