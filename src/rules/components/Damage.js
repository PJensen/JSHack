...
/**
 * Component representing a damage instance or damage-over-time effect.
 * Holds data about the damage amount, type, source, area of effect,
 * duration, and other relevant properties.
 * 
 * Systems processing damage should consume entities with this component,
 * apply damage to valid targets, and then remove or update the damage entity.
 * 
 * @property {number} amount - Primary damage amount.
 * @property {string} type - Semantic type of damage (e.g., 'physical', 'fire').
 * @property {number|string|null} source - Entity ID that caused this damage, if known.
 * @property {number} area - AoE radius in tiles (0 = single-target).
 * @property {number} duration - Duration in ticks/turns for DoT effects (0 = instant).
 * @property {number} tickInterval - Interval in ticks for applying DoT damage.
 * @property {number} armorPenetration - Amount to reduce armor protection by.
 * @property {boolean} ignoreArmor - Whether to bypass armor entirely.
 * @property {boolean} allowFriendlyFire - Whether this damage affects allies/owner.
 * @property {boolean} critical - Whether this damage is a critical hit.
 * @property {Object|null} knockback - Optional knockback vector: {dx, dy, force}.
 * @property {string|null} status - Optional status/effect to apply on hit.
 * @property {string[]} tags - Generic tags for custom logic.
 */
