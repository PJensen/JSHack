...
const SOUNDS = {
  ...
  "item:drop:armor":       { file: "drop_generic.wav",    bus: "items" },
  ...
  "spell:blizzard":      { file: "spell_frost.wav",         bus: "spells" },
  ...
  "frost_explosion":  { file: "spell_frost.wav",     bus: "spells" },
  "frost_surge":      { file: "spell_frost.wav",     bus: "spells" },
  "glass_crack":      { file: "drop_gem_lesser.wav", bus: "items" },
  "glass_shatter":    { file: "impact_potion.wav",   bus: "items" },
  "holy_beam":        { file: "spell_smite_1.mp3",   bus: "spells" },
  "holy_chime":       { file: "harp_reverb.wav",     bus: "ui" },
