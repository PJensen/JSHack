...
defineMonster('chicken_rooster', {
  ...
  aiHints: { farmAnimal: true },
  specials: ['Passive', 'Sleeps at night'],
  description: 'A proud barnyard rooster, loud by day and quiet on the roost after dark.',
});
...
defineMonster('chick', {
  ...
  glow: '#ccaa33',
  scale: 0.6,
  tags: ['beast', 'bird', 'domesticated', 'overworld', 'nameplate'],
  tier: 0,
  rare: true,
  intelligence: 1,
  visionRange: 4,
...
defineMonster('ratatoskr', {
  ...
  glow: '#8a5224',
  scale: 0.7,
  tags: ['beast', 'squirrel', 'unique', 'messenger', 'overworld', 'rare', 'elite', 'nameplate'],
  tier: 0,
  rare: true,
  intelligence: 8,
  visionRange: 7,
